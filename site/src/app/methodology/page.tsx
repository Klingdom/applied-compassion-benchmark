                  ...
                  <div className="grid grid-cols-[160px_1fr] gap-4 items-start">
                    ...
                    <ul className="list-disc pl-[18px] text-muted space-y-2">
                      <li>
                        ...
                        . The consistency factor steps down as dimension scores spread apart (standard deviation across the eight dimensions: ≤1.5 → 1.0; ≤3.0 → 0.75; ≤5.0 → 0.4; above → 0.1 — the formula defines all four steps, but with eight dimensions each bounded 0–5, σ cannot exceed 2.5, so only the first two steps ever occur in practice). The balance factor steps down by 0.2 for each dimension scoring below 4.0 (the exemplary threshold), to a floor of 0. Effect: the premium rewards dimensions that clear the 4.0 threshold, not evenness by itself — a balanced profile that keeps every dimension ≥4.0 can out-earn a spiky one (e.g. eight dimensions at 4.0 → composite 85 beats four at 5.0 and four at 3.0 → composite 77), but a spiky profile can also out-earn a balanced one that lets dimensions drop below 4.0 (e.g. four dimensions at 5.0 and four at 2.6 → composite 72 beats eight dimensions at 3.8 → composite 70). This rewards clearing the balance threshold, not sameness for its own sake.
                      </li>
                      <li>
