      ...
      <section className="py-[30px]">
        <Container className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <Panel>
            ...
            <p className="text-muted mb-3">
              Each subdimension is scored on a 0\u20135 anchored behavioral scale. The five subdimensions within a dimension are summed and converted into a dimension score out of 10. The eight dimension scores together create a base total out of 80, which is then combined with an integration premium worth up to 20 additional points to produce a 0\u2013100 composite.
            </p>
            <p className="text-muted text-[0.92rem]">
