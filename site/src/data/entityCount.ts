 ...
 *
 *   SCORED (1,156) = sum of rankings.length across the 7 published index JSON
 ...
 *
 *   SCANNED (1,160) = pipeline.entitiesScanned in the daily briefing JSON. The
 *     nightly scanner has slightly broader coverage than the published catalog.
 *     Use 1,160 only where copy literally says "scanned" (pipeline semantics).
 *
