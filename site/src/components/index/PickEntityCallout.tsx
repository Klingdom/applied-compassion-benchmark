      ...
      <Callout>
        ...
        <p className="text-muted">
          {SCORE_WATCH.useGumroad
            ? "Browse any index below, find the entity you want to track, and subscribe to Score-Watch from its detail page."
            : "Browse any index below, find the entity you want to track, and request Score-Watch access from its detail page. Self-serve subscriptions are paused."}
        </p>
      </Callout>
    </div>
  );
