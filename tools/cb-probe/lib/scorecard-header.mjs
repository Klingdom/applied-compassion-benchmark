...
export const SELF_RUN_HEADER = Object.freeze({
  ...
  what_this_is:
    ...
    "responses against the published rubric anchors, then computing a composite and band using the " +
    "SAME arithmetic Compassion Benchmark uses for its own published scores " +
    "(site/scripts/lib/scoring.mjs, computeCompositeFromDimensions -- imported directly, never " +
    "reimplemented). Same maths, unofficial status: a different formula would be more confusing, " +
    "not more honest, because it would teach a wrong mental model of what the benchmark measures. " +
    "This is still not an official Compassion Benchmark score, result, ranking, or index entry -- " +
    "see official, is_index_entry, publishable_as_a_compassion_benchmark_score, and comparability, " +
    "all structurally fixed and asserted by the validator this artifact is built against.",
