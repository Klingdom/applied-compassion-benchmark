...
// Load scan output
const scan = JSON.parse(fs.readFileSync('C:/Users/philk/applied-compassion-benchmark/research/scans/2026-06-27.json', 'utf8'));
...
// Write dated file
fs.writeFileSync(
  'C:/Users/philk/applied-compassion-benchmark/site/src/data/evidence-reviews/2026-06-27.json',
  JSON.stringify(evidenceFeed, null, 2)
);
console.log('Wrote evidence-reviews/2026-06-27.json with', Object.keys(reviews).length, 'records');
...
console.log('Updated rotation-state.json: last_scanned + last_evidence_touch =>', today, 'for', keys.length, 'entities');
